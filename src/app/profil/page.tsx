...
import { User, Lock, CreditCard, History, Upload, ArrowRight, Check, X, Eye, EyeOff, Coins, Shield, AlertTriangle, Phone } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            <ul>
              {tabs.map((tab) => (
                <li key={tab.id} onClick={() => setActiveTab(tab.id)} className={`mb-2 cursor-pointer`}>
                  <div className={`flex items-center p-3 rounded-lg ${activeTab === tab.id ? 'bg-[#FF6B00]' : 'hover:bg-gray-700'}`}>
                    {tab.icon}
